...
impl Parser {
    ...
    fn type_string(&mut self) -> ParseResult<Type> {
        ...
        if self.current.kind == TokenKind::Pipe {
            ...
            return Ok(Type::Union(Box::new(types)));
        }
        ...
        if self.current.kind == TokenKind::Ampersand {
            ...
            return Ok(Type::Intersection(Box::new(types)));
        }

        Self::parse_type(id)
    }

    fn parse_type(id: ByteString) -> ParseResult<Type> {
        Ok(match &id[..] {
            b"void" => Type::Void,
            b"never" => Type::Never,
            b"null" => Type::Null,
    ...
    fn union_typestrings_test() {
        assert_ast(
            ...
            &[Statement::Function {
                ...
                params: vec![Param {
                    name: Expression::Variable { name: "b".into() },
                    r#type: Some(Type::Union(Box::new(vec![Type::Integer, Type::Float]))),
                    variadic: false,
                    default: None,
                    flag: None,
                    by_ref: false,
        ...
        assert_ast(
            ...
            &[Statement::Function {
                ...
                params: vec![Param {
                    name: Expression::Variable { name: "b".into() },
                    r#type: Some(Type::Union(Box::new(vec![
                        Type::String,
                        Type::Integer,
                        Type::Float,
                    ]))),
    ...
    fn intersection_typestrings_test() {
        assert_ast(
            ...
            &[Statement::Function {
                ...
                params: vec![Param {
                    name: Expression::Variable { name: "b".into() },
                    r#type: Some(Type::Intersection(Box::new(vec![
